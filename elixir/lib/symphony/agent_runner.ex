defmodule Symphony.AgentRunner do
  @moduledoc """
  Executes a single GitLab issue in an isolated workspace with Codex.
  """

  require Logger
  alias Symphony.Codex.AppServer
  alias Symphony.{Config, GitLab.Issue, PromptBuilder, Tracker, Workspace}
  ...
  defp build_turn_prompt(_issue, _opts, turn_number, max_turns) do
    ...
    - The previous Codex turn completed normally, but the GitLab issue is still in an active state.
